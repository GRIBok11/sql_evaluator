...
# Промпт с прямым текстом без шаблонов-заполнителей
evaluation_prompt = PromptTemplate.from_template("""
Вы — эксперт по SQL. Проанализируйте текст ниже, содержащий описание структуры базы данных, формулировку задания и SQL-запрос, представленный студентом. Ваша задача — определить, соответствует ли SQL-запрос требованиям задачи, корректно ли он реализует логику, и дать итоговую оценку (Правильный / Неправильный) с кратким пояснением.
